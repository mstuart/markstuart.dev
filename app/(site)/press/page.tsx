  ...
  return (
    <li className="py-4">
      <div className="flex gap-3">
        <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-md bg-surface-muted text-muted ring-1 ring-line">
          {mention.iconSrc ? (
            <Image src={mention.iconSrc} alt="" width={32} height={32} className="h-full w-full object-contain" />
          ) : (
