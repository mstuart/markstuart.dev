...
export const allRepos: RepoIndexEntry[] = [
  ...
  { name: "homebrew-axi", description: "Read-only Homebrew wrapper - compact, token-efficient output for coding agents", url: "https://github.com/mstuart/homebrew-axi", stars: 0, icon: "Package", createdAt: "2026-08-09", tag: "AI & Agents" },
  { name: "pypi-axi", description: "Read-only PyPI wrapper - compact, token-efficient output for coding agents", url: "https://github.com/mstuart/pypi-axi", stars: 0, icon: "Package", createdAt: "2026-08-09", tag: "AI & Agents" },
