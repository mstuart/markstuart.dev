...
<figure className="my-8">
  ...
  <figcaption className="mt-2 text-sm leading-6 text-muted">
    John Resig speaking at JSConf US in April 2010. Photo by{" "}
    <a href="https://www.flickr.com/photos/jsconf/4586826039/">JS Conf</a>,
    resized from the original, via{" "}
    <a href="https://commons.wikimedia.org/wiki/File:John_Resig_(4586826039).jpg">
      Wikimedia Commons
    </a>{" "}
    and licensed{" "}
